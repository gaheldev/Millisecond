...
class DiagnosticRow(Adw.ExpanderRow):
    ...
    def __init__(self, root_window: Adw.ApplicationWindow, cqs, check_name: str, wiki_anchor: str|None=None, dialog_spawner: Adw.Dialog|None=None, subtitle: str|None=None, **kwargs):
