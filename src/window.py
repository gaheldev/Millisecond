...
class ProaudioSetupWindow(Adw.ApplicationWindow):
    ...
    explanations = Gtk.Template.Child()
    ...
    def __init__(self, **kwargs):
        ...
        self.main_box.append(self.explanations)

        self.preferences_page = Adw.PreferencesPage()

        self.preferences_group = Adw.PreferencesGroup()
        self.preferences_group.set_title("Diagnostics")

        self.diagnostic_row = DiagnosticRow(self.rtcqs, "root")
        self.preferences_group.add(self.diagnostic_row)
