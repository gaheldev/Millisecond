% millisecond(SECTION) | User Commands
%
% "May 13 2025"
...
millisecond - program to do something

# SYNOPSIS

**millisecond** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**millisecond** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **millisecond** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**millisecond** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    millisecond. See **foo.conf**(5) for further details.
...
**millisecond** provides some return codes, that can be used in scripts:
...
Gahel <music@gahel.fr>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Gahel
